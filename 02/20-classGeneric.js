...
var ClassGenericNamespace;
(function (ClassGenericNamespace) {
    ...
    var Chevy = /** @class */ (function (_super) {
        ...
        function Chevy() {
            return _super.call(this, "Chevy", { count: 12, diameter: 100 }) || this;
        }
        return Chevy;
    }(Automobile));
    var chevy = new Chevy();
...
})(ClassGenericNamespace || (ClassGenericNamespace = {}));
